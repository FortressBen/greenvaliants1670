...
def the_trip_with_the_crates():
    ...
    motor_left.run_for_degrees(-410,30)
    ...
    acquire_line(speed=-20)
    hub.speaker.beep(100, 0.125)
    gyro_turn_2(input_angle=250, relative=False, left_or_right=TurnType.BOTH, counter_or_clock=TurnDirection.COUNTERCLOCKWISE)
    hub.speaker.beep(100, 0.125)
